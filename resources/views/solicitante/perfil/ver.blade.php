        ...
        <nav class="d-flex column bg-dark-green min-height-100vh" style="width: 200px">
            <ul >
                <li class="nav-item active">
                    <a href="/solicitante/perfil/ver" class="nav-link" style="width:100%;">
                        ...
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nome" value="{{$usuario['name']}}" id="nome" disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row align-items-center">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="email" class="form-control" name="email" value="{{$usuario['email']}}" id="email" disabled>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <!-- Input type text -->
                                            <label for="usuario">Usuário*</label>
                                            <input type="text" class="form-control" name="usuario" id="usuario" value="{{$usuario['username']}}" disabled>
                                        </div>

                                        <div class="col-md-4 mb-3">
                                            <!-- Input type text -->
                                            <label for="senha">Senha*</label>
                                            <input type="password" class="form-control" name="senha" id="senha" value="{{$usuario['password']}}" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row align-items-center">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="custom-select" name="setor" id="setor" disabled>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="ramal" id="ramal" value="{{$usuario['ramal']}}" disabled>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="codAnydesk">Código do Anydesk</label>
                                            <input type="text" class="form-control" name="codAnydesk" value="{{$usuario['codAnydesk']}}" id="codAnydesk" disabled>
                                        </div>
                                    </div>
                                </div>
